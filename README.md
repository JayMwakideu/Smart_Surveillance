...
```
git clone https://github.com/JayMwakideu/Smart_Surveillance.git
```

2) Pull Docker Image

```
docker pull jaymwakideu/smart_surveillance
```
...
```
docker run -v /Users/:/host -p 5000:5000 -t -i jaymwakideu/smart_surveillance  /bin/bash
```
